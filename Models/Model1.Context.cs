...
namespace cppPLUS_2407.Models
{
    ...
    public partial class cppPLUSEntities : DbContext
    {
        public cppPLUSEntities()
            : base("name=cppPLUSEntities")
        {
        }
        ...
        public virtual DbSet<PersonalMaster> PersonalMasters { get; set; }
